...
BLOG_AUTHOR = "ifcopenshell"  # (translatable)
BLOG_TITLE = "ifcopenshell"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ifcopenshell.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ifcopenshell.org/"
BLOG_EMAIL = "mail@ifcopenshell.org"
BLOG_DESCRIPTION = "the open source IFC toolkit and geometry engine"  # (translatable)
